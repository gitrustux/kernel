...
/// User 64-bit code segment selector (RPL 3)
const USER_CODE_64_SELECTOR: u16 = 0x2B;

/// Null segment selector
const NULL_SELECTOR: u16 = 0;
...
/// Enter user space with a different calling convention
///
/// This is an alternative entry point that may be useful for
/// different process startup scenarios.
///
/// # Arguments
///
...
pub unsafe extern "C" fn x86_uspace_entry_simple(
    ...
    naked_asm!(
        ...
        user_ss = const USER_DATA_SELECTOR,
        user_cs = const USER_CODE_64_SELECTOR,
        default_flags = const 0x202u64, // IF = 1
    );
}

/// Default user RFLAGS value
///
...
mod tests {
    ...
    fn test_default_rflags() {
        assert_eq!(DEFAULT_USER_RFLAGS & 0x202, 0x202);
    }
}
